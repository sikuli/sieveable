var defaultQuery1 = "<LinearLayout>\n\t<ImageButton></ImageButton>\n\t<ImageButton></ImageButton>\n</LinearLayout>"
var defaultQuery2 = "<LinearLayout>\n\t<ImageButton></ImageButton></LinearLayout>"
...
var FrameComponent = React.createClass({
    ...
    render: function() {
        ...
        var copyButton = <button key="copy" className="btn btn-info" onClick={this.handleCopyButtonPressed}>
...
var tag = $('#app')[0]
React.render(<NoteBook examples={examples}/>,
   tag
)
