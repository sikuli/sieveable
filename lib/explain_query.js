...
var LISTING_RESERVED = ['listing-details', 'description', 'store-url', 'store-category', 'price',
...
function getQueryParts(query) {
    ...
    var modeIndex = queryText.lastIndexOf('mode');
...
function doChildren(elem, xml, replaceFields) {
    _.forEach(elem.children, function (c) {
        if ('name' in c && c.name != undefined) {
            ...
            var cElem = xml.ele(elementName, c.attribs, getElemData(c));
