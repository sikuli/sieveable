...
describe('test find by dataset.', function () {
  ...
  before((done) => {
    // Initialize env.ids
    env.ids = {};
    env.ids.code = ['com.facebook.orca-936981', 'com.android.chrome-1547059',
      'com.cleanmaster.mguard-40101776'];
    env.ids.listing = ['com.adobe.reader-77969', 'com.facebook.katana-666397',
      'com.android.chrome-1547059'];
    env.ids.ui = ['com.facebook.katana-666397', 'com.android.chrome-1547059',
      'com.outfit7.talkingtom2free-83'];
